...
(function(){
  ...
  function ensureShape(x){
    ...
    x.maintenanceEmail=x.maintenanceEmail!==false;\n    x.autoResidentApproval=x.autoResidentApproval===true;
